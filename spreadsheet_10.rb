...
require 'nokogiri'
require 'open-uri'
AUBE_URL = "http://annuaire-des-mairies.com/aube.html"
...
#Coller la clé
$worksheet = session.spreadsheet_by_key("1nWoPpsyhN9guKw4vgmtovwfAvriz4QgMuG-m4lEmuRU").worksheets[0]
...
def get_all_the_urls_of_aube_townhalls(url)
	...
	page.xpath('//table/tr[2]/td/table/tr/td/p/a').each do |town|
		...
		url = "http://annuaire-des-mairies.com/10/#{town_name}.html"
...
get_all_the_urls_of_aube_townhalls(AUBE_URL)
